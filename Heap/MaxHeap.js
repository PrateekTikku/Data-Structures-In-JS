...
var MaxHeap_Core = (function (_super) {
    __extends(MaxHeap_Core, _super);
    function MaxHeap_Core(comparator) {
        return _super.call(this, comparator) || this;
    }
    MaxHeap_Core.prototype.heapify = function (index) {
        var minIndex = index;
    ...
    MaxHeap_Core.prototype.insert = function (node) {
    ...
    MaxHeap_Core.prototype.maximum = function () {
        return this.tasks[0];
    };
    MaxHeap_Core.prototype.minimum = function () {
...
exports.MaxHeap_Core = MaxHeap_Core;
